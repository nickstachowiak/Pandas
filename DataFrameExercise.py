...
one = pd.DataFrame(exam_data, index=labels)
print(one)

print(one[['name', 'score']])
...
print('Question 4')
print('-------------------------------------------------------------------')
print(one[one['score'].between(15, 20)])
...
print('Question 5')
print('-------------------------------------------------------------------')
one = one.sort_values(['attempts', 'name'], ascending=[True, True])
print(one)
